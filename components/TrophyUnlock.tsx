...
export function TrophyUnlock({ visible, newBadgeIds, onConfirm }: TrophyUnlockProps) {
  ...
  return (
    <div data-testid={testIds.component.trophyUnlock.overlay()} className="star-reward-overlay" role="presentation">
      <div
        data-testid={testIds.component.trophyUnlock.dialog()}
      ...
      >
        ...
        <p id="trophy-unlock-title" className="mt-3 text-2xl font-extrabold text-purple-700">
          פְּרָס חָדָשׁ!
        </p>
        <p className="mt-1 text-lg font-bold text-amber-600">הֶשֵּׂגְתָּ תְּגָמוּל חָדָשׁ!</p>
