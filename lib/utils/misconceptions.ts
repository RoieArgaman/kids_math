...
export function detectMisconception(
  ...
  if (op === "-" && w === sum) {
    return {
      id: "sub-added",
      feedback: `כִּמְעַט! נִרְאֶה שֶׁחִבַּרְתֶּם. כָּאן צָרִיךְ לְהוֹרִיד — הַתְחִילוּ מֵ-${a} וְהוֹרִידוּ ${b}.`,
    };
  }
  ...
  if (op === "+" && w === diff) {
    return {
      id: "add-subtracted",
      feedback: "נִרְאֶה שֶׁהוֹרַדְתֶּם. כָּאן צָרִיךְ לְחַבֵּר — הוֹסִיפוּ אֶת שְׁנֵי הַמִּסְפָּרִים יַחַד.",
    };
  }
  ...
  if (isMul && w === sum) {
    return {
      id: "mul-added",
      feedback: `נִרְאֶה שֶׁחִבַּרְתֶּם. בְּכֶפֶל סוֹפְרִים קְבוּצוֹת שָׁווֹת — ${a} פְּעָמִים ${b}.`,
    };
  }
  ...
  if (op === "+" && w === product) {
    return {
      id: "add-multiplied",
      feedback: `נִרְאֶה שֶׁכָּפַלְתֶּם. כָּאן צָרִיךְ לְחַבֵּר — הוֹסִיפוּ אֶת ${a} וְ-${b} יַחַד.`,
    };
  }
