  ...
  sections: [
    {
      ...
      exercises: [
        multipleChoice(6, 0, 1, "לְאֵיזוֹ קְבוּצָה שַׁיָּיךְ הַכֶּלֶב? 🐶", ["יוֹנֵק", "עוֹף", "דָּג"], "יוֹנֵק", [], 1, "concrete"),
        multipleChoice(6, 0, 2, "לְאֵיזוֹ קְבוּצָה שַׁיָּיךְ הַדָּג? 🐟", ["דָּג", "עוֹף", "יוֹנֵק"], "דָּג", [], 1, "concrete"),
        multipleChoice(6, 0, 3, "לְאֵיזוֹ קְבוּצָה שַׁיֶּיכֶת הַיּוֹנָה? 🕊️", ["עוֹף", "דָּג", "יוֹנֵק"], "עוֹף", [], 1, "concrete"),
        multipleChoice(6, 0, 4, "לְאֵיזוֹ קְבוּצָה שַׁיֶּיכֶת הַפָּרָה? 🐄", ["יוֹנֵק", "עוֹף", "דָּג"], "יוֹנֵק", [], 1, "concrete"),
      ],
    },
    {
      id: "day-6-section-1",
      ...
      prerequisiteSkillTags: [],
      exercises: [
        multipleChoice(6, 1, 1, "לְאֵיזוֹ קְבוּצָה שַׁיָּיךְ הַנָּחָשׁ? 🐍", ["זוֹחֵל", "עוֹף", "יוֹנֵק"], "זוֹחֵל", [], 2, "abstract"),
        multipleChoice(6, 1, 2, "לְאֵיזוֹ קְבוּצָה שַׁיֶּיכֶת הַדְּבוֹרָה? 🐝", ["חֶרֶק", "דָּג", "זוֹחֵל"], "חֶרֶק", [], 2, "abstract"),
