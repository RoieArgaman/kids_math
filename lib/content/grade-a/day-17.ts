...
export const concept: DayConcept = {
  ...
  objective:
    "בְּסוֹף הַיּוֹם הַתַּלְמִיד/ה יִתְרַגֵּל בְּחִיבּוּר אֹרְכִים בְּס״מ וְיִקְשֹׁר לִסְפִירָה.",  teachingSummary:
    "תִרְגּוּל: חִיבּוּר אֹרְכִים בְּסִנטִימֶטְרִים — רַק כְּשֶׁהַיְּחִידוֹת זוֹהוֹת.",
  teachingSteps: [
    "מוֹדְדִים כָּל חֵלֶק בִּנְפֹרֶד.",
    "מְחַבְּרִים אֶת הַמְסְפָּרִים כְּשֶׁהַסִּימָן הוּא +.",
  ...
  languagePrompt: "בִּחְרוּ בִּמִילִים: כַּמָּה ס״מ בִּשְׁנֵי סַרְגְּלִים שֶׁל 6 ס״מ כָּל אֶחָד?",
  languageOptions: ["עֶשֶׂר", "שְׁתֵּים עֶשְׂרֵה", "אַרְבַּע עֶשְׂרֵה"],
