...
export const concept: DayConcept = {
  ...
  languagePrompt: "בַּחֲרוּ: אֵיךְ כּוֹתְבִים בְּעִבְרִית אֶת הַמִּסְפָּר 14?",
  ...
  reviewAnswer: true,
  challengePrompt: "עַל קַו הַמִּסְפָּרִים: מִ-5 עַד 15 בִּקְפִיצוֹת שֶׁל 5. כַּמָּה קְפִיצוֹת?",
  challengeAnswer: 2,
};
