...
export const concept: DayConcept = {
  ...
  objective: "בְּסוֹף הַיּוֹם הַתַּלְמִיד/ה יוּכַל לִפְתּוֹר תַּרְגִּילֵי חִיבּוּר עַד 10 בְּ-4 מִתּוֹךְ 5 מְשִׂימוֹת.",  teachingSummary:
    "הַיּוֹם נִתְרַגֵּל לְחַבֵּר מִסְפָּרִים קְטַנִּים עַד 10: קוֹדֶם מַזְהִים אֶת הַחֵלֶקִים בַּמִּשְׁפָּט, אַחַר כָּךְ מְאַחֲדִים לִסְכּוּם.",
  teachingSteps: [
    "מְחַפְּשִׂים בַּשְּׁאֵלָה: מָה מַתְחִיל וּמָה נוֹסָף.",
    "מְחַבְּרִים בְּקִפּוּאִים, בְּאֶצְבָּעוֹת אוֹ עַל קַו מִסְפָּרִים.",
    "בּוֹדְקִים: הַאִם הַתּוֹצָאָה בִּטְחוֹן עַד 10.",
  ],
