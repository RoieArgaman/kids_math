...
export const concept: DayConcept = {
  ...
  objective:
    "בְּסוֹף הַיּוֹם הַתַּלְמִיד/ה יוּכַל לְהַבְדִּיל בֵּין הַזָּזָה (בְּלִי סִיבּוּב) לְבֵין שִׁיקּוּף, וְלִזְהוֹת צוּרָה סִימֶטְרִית שֶׁנִּשְׁאֶרֶת דּוֹמָה אַחֲרֵי שִׁיקּוּף אוֹפְקִי.",  teachingSummary:
