...
export const concept: DayConcept = {
  ...
  arithmeticPrompt: "כַּמָּה צְלָעוֹת שָׁווֹת יֵשׁ לְרִיבּוּעַ?",
  arithmeticAnswer: 4,
  arithmeticMcOptions: ["3", "4", "5"],
  arithmeticMcAnswer: "4",
  languagePrompt: "בַּחֲרוּ: כַּמָּה צִירֵי סִימֶטְרְיָה יֵשׁ לְרִיבּוּעַ?",
  languageOptions: ["4", "2", "6"],
  languageAnswer: "4",
  reviewPrompt: "אֱמֶת אוֹ שֶׁקֶר: רִיבּוּעַ דּוֹמֶה לְעַצְמוֹ אַחֲרֵי שִׁיקּוּף",
  reviewAnswer: true,
  challengePrompt: "בַּצִּיּוּר הָיוּ 4 שׁוּרוֹת. בְּכָל שׁוּרָה 10 כּוֹכָבִים. כַּמָּה כּוֹכָבִים?",
  challengeAnswer: 40,
