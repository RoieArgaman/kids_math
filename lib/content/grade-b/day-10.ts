...
export const concept: DayConcept = {
  ...
  languagePrompt: "בַּחֲרוּ: אֵיךְ כּוֹתְבִים בְּמִילִים 100?",
  languageOptions: ["מֵאָה", "תִּשְׁעִים", "מֵאָה וְעֶשֶׂר"],
  languageAnswer: "מֵאָה",
  reviewPrompt: "אֱמֶת אוֹ שֶׁקֶר: בְּסִדְרָה שֶׁמּוֹסִיפָה 7 כָּל פַּעַם וּמַתְחִילָה בְּ-14, הַמִּסְפָּר הַבָּא הוּא 20",
  reviewAnswer: false,
