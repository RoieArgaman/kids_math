...
export const concept: DayConcept = {
  ...
  languagePrompt: "בִּחְרוּ: מָה עוֹשִׂים קוֹדֶם כְּשֶׁאֵין מַסְפִּיק אֲחָדוֹת לְהַחְסִיר?",
  languageOptions: ["פּוֹרְקִים עֲשָׂרָה", "מוֹסִיפִים עֲשָׂרָה", "מַחְסִירִים עֲשָׂרָה"],
  languageAnswer: "פּוֹרְקִים עֲשָׂרָה",
