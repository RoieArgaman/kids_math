...
export const concept: DayConcept = {
  ...
  languagePrompt: "בַּחֲרוּ: מַהוּ הַמִּסְפָּר הַקָּטָן מִבֵּין 88 וְ-91?",
  ...
  reviewAnswer: true,
  challengePrompt: "בְּרֶשֶׁת יֵשׁ 7 שׁוּרוֹת וּבְכָל שׁוּרָה 8 מִשְׁבְּצוֹת. 20 מֵהֶן רֵיקוֹת. כַּמָּה מְלֵאוֹת?",
  challengeAnswer: 36,
