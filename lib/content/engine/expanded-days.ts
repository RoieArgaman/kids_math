...
export const buildExpandedExercisesForDay = (
  ...
  return [
    ...
    },
    {
      ...
      example: (() => {
        if (d === 8) return {
          ...
          prompt: "לִמְשֻׁלָּשׁ יֵשׁ 3 צְלָעוֹת. לְרִיבּוּעַ יֵשׁ 4 צְלָעוֹת.",
          steps: [
            "מְזַהִים כַּמָּה צְלָעוֹת יֵשׁ לְכָל צוּרָה.",
            "לִמְשֻׁלָּשׁ = 3 צְלָעוֹת, לְרִיבּוּעַ = 4 צְלָעוֹת.",
            "סוֹפְרִים אֶת הַצְּלָעוֹת כְּדֵי לְזַהוֹת אֶת הַצּוּרָה.",
          ],
          takeaway: "כָּל צוּרָה מְזוּהָה לְפִי מִסְפַּר הַצְּלָעוֹת שֶׁלָּהּ.",
        };
        if (d === 9) return {
          ...
          steps: [
            ...
            "6 = 3 + 3, כָּל טוּר שָׁוֶה — אֵין שְׁאֵרִית.",
        ...
        if (d === 10) return {
          ...
          prompt: "בַּמִּסְפָּר 47, כַּמָּה עֲשָׂרוֹת וְכַמָּה אֲחָדוֹת?",
          steps: [
            "47 = 40 + 7.",
            "הַסִּפְרָה 4 בִּמְקוֹם הָעֲשָׂרוֹת = 4 עֲשָׂרוֹת = 40.",
            "הַסִּפְרָה 7 בִּמְקוֹם הָאֲחָדוֹת = 7 אֲחָדוֹת.",
          ],
        ...
        if (d === 11) return {
          ...
          takeaway: "בְּחִיבּוּר עֲשָׂרוֹת שְׁלֵמוֹת, מְחַבְּרִים רַק אֶת הָעֲשָׂרוֹת וּמוֹסִיפִים אֶפֶס.",
        };
        if (d === 12) return {
        ...
        if (d === 13) return {
          title: "דֻּגְמָה פְּתוּרָה — בְּעָיָה בִּשְׁנֵי שְׁלָבִים",
          prompt: "הָיוּ 15 יְלָדִים. 4 הָלְכוּ הַבַּיְתָה וְ-3 הִצְטָרְפוּ. כַּמָּה עַכְשָׁיו?",
          steps: [
            "שָׁלָב 1: 15 - 4 = 11 יְלָדִים נִשְׁאֲרוּ.",
            "שָׁלָב 2: 11 + 3 = 14 יְלָדִים עַכְשָׁיו.",
            "בּוֹדְקִים: הַתּוֹצָאָה הִגְיוֹנִית?",
          ],
          takeaway: "בִּבְעָיָה בִּשְׁנֵי שְׁלָבִים — פּוֹתְרִים שָׁלָב אַחַר שָׁלָב, לְפִי הַסֵּדֶר.",
        };
        // d === 14 — review day
        return {
          title: "דֻּגְמָה פְּתוּרָה — חִישּׁוּב מְשֻׁלָּב",
      ...
      exercises: [
        ...
        numberInput(
          ...
          7,
          d === 8
            ? "לִמְרֻבָּע יֵשׁ 4 צְלָעוֹת. לְ-4 מְרֻבָּעִים יֵשׁ כַּמָּה צְלָעוֹת?"
            : d === 9
                ...
                : d === 11
                  ...
                  : d === 12
                    ...
                    : d === 13
                      ...
                      : "בַּחֲרוּ תַּרְגִּיל עִם שְׁתֵּי פְּעוּלוֹת בְּדִיּוּק.",
          d === 8
    ...
    },
    {
      ...
      learningGoal: "לְנַסֵּחַ בְּמִילִּים פְּתָרוֹנוֹת וּלְקַשֵּׁר לִצּוּרוֹת וּלַמִּסְפָּרִים.",
      prerequisiteSkillTags: concept.mainTags,
      exercises: [
        multipleChoice(
          d,
        ...
        concept.geometryPrompt && concept.geometryAnswer
          ...
          : multipleChoice(
              ...
              3,
              4,
              `אֵיזֶה סִימָן מַתְאִים בֵּין 19 לְבֵין 23 ?`,
              ["<", ">", "="],
              "<",
              ["comparing"],
              dayDifficulty,
        ...
        multipleChoice(
          ...
          d === 8
            ...
            : d === 9
              ? "אֵיזֶה מִסְפָּר יַתְאִים אַחֲרֵי 12 בְּסִדְרָה בִּקְפִיצוֹת שֶׁל 4?"
              : d === 10
                ? "בַּמִּסְפָּר 36, מַהִי סִפְרַת הָעֲשָׂרוֹת?"
                : d === 11
        ...
        numberInput(
          ...
          9,
          d === 8
            ? "לִשְׁנֵי רִיבּוּעִים וּלִמְשֻׁלָּשׁ אֶחָד יֵשׁ כַּמָּה צְלָעוֹת?"
            : d === 9
        ...
        trueFalse(
          ...
          d === 8
            ...
            : d === 9
              ? "הַאִם נָכוֹן: 10, 15, 20, 25 הִיא סִדְרָה בִּקְפִיצוֹת שֶׁל 5?"
              : d === 10
    ...
    },
    {
      ...
      exercises: [
        ...
        numberInput(
          ...
          5,
          d === 8
            ? "לִמְרֻבָּע יֵשׁ 4 צְלָעוֹת. כַּמָּה צְלָעוֹת יֵשׁ לִשְׁנֵי מְרֻבָּעִים?"
            : d === 9
        ...
        numberInput(
          ...
          6,
          d === 8
            ? "לִמְשֻׁלָּשׁ יֵשׁ 3 צְלָעוֹת וּלְמַלְבֵּן יֵשׁ 4. כַּמָּה צְלָעוֹת לָהֶם יַחַד?"
            : d === 9
        ...
        trueFalse(
          ...
          d === 8
            ...
            : d === 9
              ? "טָעוּת אוֹ נָכוֹן: 2, 4, 8, 10 הִיא סִדְרָה קְבוּעָה בִּקְפִיצוֹת שֶׁל 2."
              : d === 10
                ...
                : d === 11
                  ...
                  : d === 12
                    ...
                    : d === 13
                      ...
                      : "הַאִם הַמִּשְׁפָּט נָכוֹן: 45 + 10 - 5 = 50.",
          d === 13 || d === 14,
          concept.mainTags,
          dayDifficulty,
          "abstract",
        ...
        multipleChoice(
          ...
          d === 8
            ...
            : d === 9
              ...
              : d === 10
                ? "בַּמִּסְפָּר 31, מַהִי סִפְרַת הָעֲשָׂרוֹת?"
                : d === 11
                  ? "בַּחֲרוּ אֶת מִשְׁפַּט הַחִיבּוּר הַנָּכוֹן."
                  : d === 12
                    ? "בַּחֲרוּ אֶת מִשְׁפַּט הַחִיסּוּר הַנָּכוֹן."
                    : d === 13
    ...
    },
    {
      ...
      exercises: [
        ...
        numberInput(
          ...
          7,
          d === 8
            ? "אֶתְגָּר צוּרוֹת: לִמְשֻׁלָּשׁ וּלְרִיבּוּעַ יַחַד יֵשׁ כַּמָּה צְלָעוֹת?"
            : d === 9
              ? "אֶתְגָּר סִדְרָה: 4, 9, 14, __"
              : d === 10
                ? "אֶתְגָּר עֶרֶךְ מָקוֹם: בַּמִּסְפָּר 76 — מַהִי סִפְרַת הָעֲשָׂרוֹת?"
                : d === 11
                  ? "אֶתְגָּר לַיּוֹם: חַשְּׁבוּ 30 + 60."
                  : d === 12
                    ? "אֶתְגָּר לַיּוֹם: חַשְּׁבוּ 100 - 70."
                    : d === 13
                      ? "אֶתְגָּר מִילּוּלִי: בַּסַּל 28 פֵּרוֹת, 9 נֶאֱכְלוּ וְאַחַר כָּךְ הוֹסִיפוּ 6. כַּמָּה נִשְׁאַר?"
                      : "אֶתְגָּר סִכּוּם: פִּתְרוּ 40 + 15 - 8.",
          d === 8 ? 7 : d === 9 ? 19 : d === 10 ? 7 : d === 11 ? 90 : d === 12 ? 30 : d === 13 ? 25 : 47,
          concept.mainTags,
          dayDifficulty,
          "abstract",
        ),
        ...
        trueFalse(
          ...
          d === 8
            ...
            : d === 9
              ? "הַאִם נָכוֹן: 2, 7, 12, 17 הִיא סִדְרָה בִּקְפִיצוֹת שֶׁל 5?"
              : d === 10
