...
export const testIds = {
  screen: {
    ...
    adminProgress: {
      ...
      subjectSelect: () => tid("screen", "adminProgress", "subject", "select"),
      gradeSelect: () => tid("screen", "adminProgress", "grade", "select"),
      refresh: () => tid("screen", "adminProgress", "cta", "refresh"),
  ...
  component: {
    ...
    auth: {
      ...
      showPasswordToggle: () => tid("component", "auth", "loginModal", "showPassword"),
      submitButton: () => tid("component", "auth", "loginModal", "submit"),
      errorMessage: () => tid("component", "auth", "loginModal", "error"),
      lockoutCountdown: () => tid("component", "auth", "loginModal", "lockoutCountdown"),
      ...
      logoutEverywhereButton: () => tid("component", "auth", "avatar", "logoutEverywhere"),
    ...
    adminUsers: {
      ...
      overridePolicyToggle: () => tid("component", "adminUsers", "addForm", "overridePolicy"),
      submitButton: () => tid("component", "adminUsers", "addForm", "submit"),
      lockedBadge: (userId: string) => tid("component", "adminUsers", "user", userId, "lockedBadge"),
      unlockButton: (userId: string) => tid("component", "adminUsers", "user", userId, "unlock"),
      changePasswordOverride: (userId: string) => tid("component", "adminUsers", "user", userId, "changePw", "override"),
      ...
      deleteDialog: () => tid("component", "adminUsers", "deleteDialog"),
      deleteDialogTitle: () => tid("component", "adminUsers", "deleteDialog", "title"),
      statusBadge: (userId: string) => tid("component", "adminUsers", "user", userId, "statusBadge"),
      ...
      exportButton: (userId: string) => tid("component", "adminUsers", "user", userId, "export"),
    },
  },
} as const;
