  ...
  return (
    <main data-testid={root} className="mx-auto w-full max-w-[720px] space-y-5 px-4 pb-14 pt-8">
      ...
      <LegalSection
        rootTestId={root}
        sectionKey="account"
        title="חשבון משתמש: מה נשמר אצלנו"
        paragraphs={[
          "אם נוצר לילד חשבון, נשמרים אצלנו שם המשתמש, סיסמה מוצפנת וההתקדמות בלימודים. איננו שומרים דואר אלקטרוני, טלפון, כתובת, שם מלא או תאריך לידה.",
        ]}
        listItems={[
          "בקשת עותק: מנהל המערכת יכול להפיק קובץ עם כל המידע השמור על הילד ולמסור אותו להורה.",
          "השבתה ומחיקה: מנהל המערכת יכול להשבית או למחוק חשבון (ראו למטה מה קורה למידע).",
          "בעת מחיקה או השבתה הילד מנותק מיד מכל המכשירים, והמידע המקומי נמחק מהמכשיר בפעם הבאה שהאפליקציה נטענת.",
        ]}
      />
      ...
      <LegalSection
        ...
        paragraphs={[
          "המידע נשמר בענן של Google באירופה, כל עוד החשבון קיים. אין מחיקה אוטומטית אחרי פרק זמן מסוים, ואיננו מוחקים מידע מיוזמתנו.",
        ]}
        listItems={[
          "מחיקת חשבון עוצרת כניסה וסנכרון, אך הנתונים עצמם נשמרים אצלנו כדי לאפשר שחזור. מחיקה מוחלטת עדיין לא קיימת במערכת, ואנחנו אומרים זאת בגלוי.",
          "עותקי גיבוי נשמרים עד 14 ימים נוספים, ולכן מידע עשוי להיות ניתן לשחזור גם אחרי מחיקת חשבון.",
          "אפשר תמיד למחוק את המידע השמור במכשיר עצמו דרך הגדרות הדפדפן.",
        ]}
      />
      ...
      <LegalSection
        ...
        title="זכויות ופניות"
        paragraphs={[
          "ניתן למחוק נתונים מקומיים דרך הגדרות הדפדפן (אחסון לאתר) או באמצעות כלים שיפורסמו באפליקציה. לבקשות בנושא פרטיות, קבלת עותק של המידע או מחיקת חשבון ניתן לפנות לבעל השירות בערוץ שיפורסם.",
        ]}
      />
    </main>
  );
